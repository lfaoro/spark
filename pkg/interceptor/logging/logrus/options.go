...
// WithReporting adds Stackdriver error reporting and enabled the reporting of
// errors based on the grpc status code. Every value over 1, will be reported.
//
// gRPC status codes ref:
// https://github.com/grpc/grpc/blob/master/doc/statuscodes.md
func WithReporting(r *errorreporting.Client) Option {
	return func(o *options) {
		o.reporting = r
	}
}
