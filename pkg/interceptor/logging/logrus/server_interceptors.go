...
func UnaryServerInterceptor(entry *logrus.Entry, opts ...Option) grpc.UnaryServerInterceptor {
	...
	return func(ctx context.Context, req interface{}, info *grpc.UnaryServerInfo, handler grpc.UnaryHandler) (interface{}, error) {
		...
		// skip codes: OK, CANCELLED, NOT FOUND, UNAUTHENTICATED
		// codes ref: https://github.com/grpc/grpc/blob/master/doc/statuscodes.md
		switch code {
		case 0, 1, 5, 15:
			return resp, err
		}
		...
		if o.reporting != nil {
			o.reporting.Report(er.Entry{
				Error: fmt.Errorf("something happend with method %v which produced error %v", method, code.String()),
				Req:   nil, // todo: find a way to stick the grpc request in it
				User:  "",  // todo: extract user from context
			})
		}
